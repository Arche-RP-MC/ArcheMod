...
public class BlocFruits extends BlockCrops {
    ...
    public BlocFruits(String name, Item seed, Item crop, int dropsWhenMature, int dropsWhenRightClicked, int dropsWhenBroken) {
