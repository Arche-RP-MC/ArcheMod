...
public class BlocPlantesPaysanCereales extends BlockCrops {
    ...
    public BlocPlantesPaysanCereales(String name, Item seed, Item crop, int dropsWhenMature, int dropsWhenRightClicked, int dropsWhenBroken, Item tool) {
