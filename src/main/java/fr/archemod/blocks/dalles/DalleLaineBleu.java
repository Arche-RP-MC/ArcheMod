...
public abstract class DalleLaineBleu extends BlockSlab{


	public static final PropertyEnum<EnumVariant> VARIANT = PropertyEnum.<EnumVariant>create("variant", EnumVariant.class);

	public DalleLaineBleu(String name, float hardness, float resistance, Material materialIn, SoundType sound) {
		super(materialIn);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.DALLE_LAINE_BLEU);
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
		return new ItemStack(ModBlocks.DALLE_LAINE_BLEU);
	}

	public static class Double extends DalleLaineBleu {
	...
	public static class Half extends DalleLaineBleu {
