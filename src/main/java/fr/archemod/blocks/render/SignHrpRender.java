package fr.archemod.blocks.render;
...
public class SignHrpRender extends TileEntitySpecialRenderer<TileEntitySignHrp> {
    private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(Reference.MOD_ID,"textures/entity/sign_hrp.png");
    private final ModelSignHrp model = new ModelSignHrp();


    @Override
    public void render(TileEntitySignHrp te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
