...
public class TileEntityFourSechoir2 extends TileEntity implements IInventory, ITickable
{
...
{
    return this.hasCustomName() ? this.customName : "sechoir_viandes";
}
...
public void  update()
{
    ...
    if(!this.world.isRemote)
    {
        ...
        {
            flag1 = true;
            BlockFourSechoir2.setState(this.isBurning(),this.world,this.pos);
        }
...
private boolean canSmelt()
{
    ...
    {
        ItemStack result = SechoirViandeRecipe.getInstance().getSechoirResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
...
public void smeltItem()
{
    if(this.canSmelt())
    {
        ...
        ItemStack result = SechoirViandeRecipe.getInstance().getSechoirResult(input1, input2);
        ItemStack output = (ItemStack) this.inventory.get(3);
...
public static int getItemBurnTime (ItemStack fuel)
{
    ...
    else
    {
        ...
        if(item == ModItems.SEL) return 200;
