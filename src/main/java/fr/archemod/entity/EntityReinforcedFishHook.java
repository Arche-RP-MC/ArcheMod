package fr.archemod.entity;

import fr.archemod.util.ArcheLootTables;
...
public class EntityReinforcedFishHook extends EntityFishHook {
    private static final DataParameter<Integer> DATA_HOOKED_ENTITY = EntityDataManager.<Integer>createKey(EntityReinforcedFishHook.class, DataSerializers.VARINT);
    ...
    public EntityReinforcedFishHook(World worldIn, EntityPlayer player, double x, double y, double z) {
    ...
    public EntityReinforcedFishHook(World worldIn, EntityPlayer fishingPlayer) {
        super(worldIn, fishingPlayer);
        this.init(fishingPlayer);
        this.shoot();
    }

    public EntityReinforcedFishHook(World worldIn) {
        super(worldIn, null);
    ...
    public int handleHookRetraction() {
        if (!this.world.isRemote && this.angler != null) {
            ...
            if (this.caughtEntity != null) {
                ...
                List<ItemStack> result = this.world.getLootTableManager().getLootTableFromLocation(ArcheLootTables.REINFORCED_FISHING_LOOTS).generateLootForPools(this.rand, lootcontext$builder.build());
