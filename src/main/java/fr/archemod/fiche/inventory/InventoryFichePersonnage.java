package fr.archemod.fiche.inventory;
...
public class InventoryFichePersonnage implements IInventory {
    private final NonNullList<ItemStack> content;
    public int size;

    public InventoryFichePersonnage(ItemStack container, int size) {
        this.size = size;
    ...
    public InventoryFichePersonnage(int size) {
        this.size = size;
        this.content = NonNullList.<ItemStack>withSize(size, ItemStack.EMPTY);
    }
