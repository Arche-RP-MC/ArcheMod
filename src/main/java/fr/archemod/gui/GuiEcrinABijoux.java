...
public class GuiEcrinABijoux extends GuiContainer {
    public static final ResourceLocation texture = new ResourceLocation("textures/gui/container/generic_54.png");
    protected TileEntityEcrinABijoux inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public GuiEcrinABijoux(InventoryPlayer playerInv, TileEntityEcrinABijoux inv) {
        super(new ContainerEcrinABijoux(playerInv, inv));
