...
public class GuiFishCase extends GuiContainer {

    public static final ResourceLocation texture = new ResourceLocation("textures/gui/container/generic_54.png");
    protected TileEntityFishCase inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public GuiFishCase(InventoryPlayer playerInv, TileEntityFishCase inv) {
        super(new ContainerFishCase(playerInv, inv));
