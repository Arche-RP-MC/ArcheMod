...
public class GuiPlacardHRP extends GuiContainer {
    public static final ResourceLocation texture = new ResourceLocation("textures/gui/container/generic_54.png");
    protected TileEntityPlacardHRP inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public GuiPlacardHRP(InventoryPlayer playerInv, TileEntityPlacardHRP inv) {
        super(new ContainerPlacardHRP(playerInv, inv));
