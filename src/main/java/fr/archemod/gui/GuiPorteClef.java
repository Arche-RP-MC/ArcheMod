...
import fr.archemod.items.inventory.container.ContainerPorteClef;
...
public class GuiPorteClef extends GuiContainer {
    public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/container/generic_36.png");
    protected InventoryPorteClef inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public GuiPorteClef(InventoryPlayer playerInv, InventoryPorteClef inv) {
        super(new ContainerPorteClef(playerInv, inv));
