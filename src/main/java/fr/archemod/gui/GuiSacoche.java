...
public class GuiSacoche extends GuiContainer {
    public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID,"textures/gui/container/generic_36.png");
    protected InventorySacoche inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public GuiSacoche(InventoryPlayer playerInv, InventorySacoche inv) {
        super(new ContainerSacoche(playerInv, inv));
