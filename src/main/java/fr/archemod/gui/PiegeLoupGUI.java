...
public class PiegeLoupGUI extends GuiContainer {
    public static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID,"textures/gui/container/recolte.png");
    protected TileEntityPiegeLoup inv;
    protected InventoryPlayer playerInv;
    public int rows;

    public PiegeLoupGUI(InventoryPlayer playerInv, TileEntityPiegeLoup inv) {
        super(new ContainerPiegeLoup(playerInv, inv));
