...
public class ModBlocks {
    ...
    public static final Block NASSE = new BlockNasse("nasse", Material.WOOD, 0.5F, 0.5F, SoundType.WOOD);
    ...
    //Insectes
    private static final Block PLAN_ABEILLE = new BlocCulture("plan_abeille", ModItems.GRAINE_ABEILLE, ModItems.INSECTE_ABEILLE, insecte, 2, 2, 0);
    private static final Block PLAN_ARAIGNEE = new BlocCulture("plan_araignee", ModItems.GRAINE_ARAIGNEE, ModItems.INSECTE_ARAIGNEE, insecte, 2, 2, 0);
    private static final Block PLAN_ASTICOT = new BlocCulture("plan_asticot", ModItems.GRAINE_ASTICOT, ModItems.INSECTE_ASTICOT, insecte, 2, 2, 0);
    private static final Block PLAN_CHENILLE = new BlocCulture("plan_chenille", ModItems.GRAINE_CHENILLE, ModItems.INSECTE_CHENILLE, insecte, 2, 2, 0);
    private static final Block PLAN_COCCINELLE = new BlocCulture("plan_coccinelle", ModItems.GRAINE_COCCINELLE, ModItems.INSECTE_COCCINELLE, insecte, 2, 2, 0);
    private static final Block PLAN_COCHENILLE = new BlocCulture("plan_cochenille", ModItems.GRAINE_COCHENILLE, ModItems.INSECTE_COCHENILLE, insecte, 2, 2, 0);
    private static final Block PLAN_ESCARGOT = new BlocCulture("plan_escargot", ModItems.GRAINE_ESCARGOT, ModItems.INSECTE_ESCARGOT, insecte, 2, 2, 0);
    private static final Block PLAN_FOURMI = new BlocCulture("plan_fourmi", ModItems.GRAINE_FOURMI, ModItems.INSECTE_FOURMI, insecte, 2, 2, 0);
    private static final Block PLAN_GALLE = new BlocCulture("plan_galle", ModItems.GRAINE_GALLE, ModItems.INSECTE_GALLE, insecte, 2, 2, 0);
    private static final Block PLAN_GUEPE = new BlocCulture("plan_guepe", ModItems.GRAINE_GUEPE, ModItems.INSECTE_GUEPE, insecte, 2, 2, 0);
    private static final Block PLAN_LARVE = new BlocCulture("plan_larve", ModItems.GRAINE_LARVE, ModItems.INSECTE_LARVE, insecte, 2, 2, 0);
    private static final Block PLAN_MITE = new BlocCulture("plan_mite", ModItems.GRAINE_MITE, ModItems.INSECTE_MITE, insecte, 2, 2, 0);
    private static final Block PLAN_MORPION = new BlocCulture("plan_morpion", ModItems.GRAINE_MORPION, ModItems.INSECTE_MORPION, insecte, 2, 2, 0);
    private static final Block PLAN_MOUCHE = new BlocCulture("plan_mouche", ModItems.GRAINE_MOUCHE, ModItems.INSECTE_MOUCHE, insecte, 2, 2, 0);
    private static final Block PLAN_PAPILLON_COMMUN = new BlocCulture("plan_papillon_commun", ModItems.GRAINE_PAPILLON_COMMUN, ModItems.INSECTE_PAPILLON_COMMUN, insecte, 2, 2, 0);
    private static final Block PLAN_PAPILLON_RARE = new BlocCulture("plan_papillon_rare", ModItems.GRAINE_PAPILLON_RARE, ModItems.INSECTE_PAPILLON_RARE, insecte, 2, 2, 0);
    private static final Block PLAN_PUCERON = new BlocCulture("plan_puceron", ModItems.GRAINE_PUCERON, ModItems.INSECTE_PUCERON, insecte, 2, 2, 0);
    private static final Block PLAN_SCARABEE = new BlocCulture("plan_scarabee", ModItems.GRAINE_SCARABEE, ModItems.INSECTE_SCARABEE, insecte, 2, 2, 0);
    private static final Block PLAN_SCORPION = new BlocCulture("plan_scorpion", ModItems.GRAINE_SCORPION, ModItems.INSECTE_SCORPION, insecte, 2, 2, 0);
    private static final Block PLAN_TIQUE = new BlocCulture("plan_tique", ModItems.GRAINE_TIQUE, ModItems.INSECTE_TIQUE, insecte, 2, 2, 0);
    private static final Block PLAN_VER_DE_FARINE = new BlocCulture("plan_ver_de_farine", ModItems.GRAINE_VER_DE_FARINE, ModItems.INSECTE_VER_DE_FARINE, insecte, 2, 2, 0);
    private static final Block PLAN_VER_DE_TERRE = new BlocCulture("plan_ver_de_terre", ModItems.GRAINE_VER_DE_TERRE, ModItems.INSECTE_VER_DE_TERRE, insecte, 2, 2, 0);
    private static final Block PLAN_VER_A_SOIE = new BlocCulture("plan_ver_a_soie", ModItems.GRAINE_VER_A_SOIE, ModItems.VER_A_SOIE, insecte, 2, 2, 0);
    ...
    public static final Block PIEGE_A_LOUP = new BlockPiegeLoup("piege_a_loup", Material.ROCK, 5F, 5F, SoundType.STONE, new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.15D, 1.0D));
...
// BLOC Pour CHisel
    ...
    */
    ...
    public static void init() {
        ...
        //cultures
        ModItems.GRAINE_LIN = new ItemGraine("graine_lin", ModBlocks.PLAN_DE_LIN, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_CELERI = new ItemGraine("graine_celeri", ModBlocks.PLAN_CELERI, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_FENOUIL = new ItemGraine("graine_fenouil", ModBlocks.PLAN_FENOUIL, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_FRAISE = new ItemGraine("graine_fraise", ModBlocks.PLAN_FRAISE, Blocks.DIRT);
        ModItems.GRAINE_FRAMBOISE = new ItemGraine("graine_framboise", ModBlocks.PLAN_FRAMBOISE, Blocks.DIRT);
        ModItems.GRAINE_MAIS = new ItemGraine("graine_mais", ModBlocks.PLAN_MAIS, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_MYRTILLE = new ItemGraine("graine_myrtille", ModBlocks.PLAN_MYRTILLE, Blocks.DIRT);
        ModItems.GRAINE_NAVET = new ItemGraine("graine_navet", ModBlocks.PLAN_NAVET, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_ORGE = new ItemGraine("graine_orge", ModBlocks.PLAN_ORGE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_POIREAU = new ItemGraine("graine_poireau", ModBlocks.PLAN_POIREAU, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_RADIS = new ItemGraine("graine_radis", ModBlocks.PLAN_RADIS, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_SALSIFI = new ItemGraine("graine_salsifi", ModBlocks.PLAN_SALSIFI, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_TOMATE = new ItemGraine("graine_tomate", ModBlocks.PLAN_TOMATE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_VIGNE_NOIRE = new ItemGraine("graine_vigne_noire", ModBlocks.PLAN_VIGNE_NOIRE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_VIGNE_BLANCHE = new ItemGraine("graine_vigne_blanche", ModBlocks.PLAN_VIGNE_BLANCHE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_CHOU = new ItemGraine("graine_chou", ModBlocks.PLAN_CHOU, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_EPINARD = new ItemGraine("graine_epinard", ModBlocks.PLAN_EPINARD, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_DE_THE = new ItemGraine("graine_the", ModBlocks.PLAN_THE, Blocks.DIRT);
        ModItems.GRAINE_SALADE = new ItemGraine("graine_salade", ModBlocks.PLAN_SALADE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_ARTICHAUT = new ItemGraine("graine_artichaut", ModBlocks.PLAN_ARTICHAUT, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_BROCOLIS = new ItemGraine("graine_brocolis", ModBlocks.PLAN_BROCOLIS, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_ASPERGE = new ItemGraine("graine_asperge", ModBlocks.PLAN_ASPERGE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_ENDIVE = new ItemGraine("graine_endive", ModBlocks.PLAN_ENDIVE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_RIZ = new ItemGraine("graine_riz", ModBlocks.PLAN_RIZ, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_BLE = new ItemGraine("graine_ble", ModBlocks.PLAN_BLE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_THYM = new ItemGraine("graine_thym", ModBlocks.PLAN_THYM, Blocks.DIRT);
        ModItems.GRAINE_CHANVRE = new ItemGraine("GRAINE_CHANVRE", ModBlocks.PLAN_CHANVRE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_BASILIC = new ItemGraine("graine_basilic", ModBlocks.PLAN_BASILIC, Blocks.DIRT);
        ModItems.GRAINE_ANETH = new ItemGraine("graine_aneth", ModBlocks.PLAN_ANETH, Blocks.DIRT);
        ModItems.GRAINE_ANIS = new ItemGraine("graine_anis", ModBlocks.PLAN_ANIS, Blocks.DIRT);
        ModItems.GRAINE_BELLE_DE_NUIT = new ItemGraine("graine_belle_de_nuit", ModBlocks.PLAN_BELLE_DE_NUIT, Blocks.DIRT);
        ModItems.GRAINE_BLEUETS = new ItemGraine("graine_bleuets", ModBlocks.PLAN_BLEUETS, Blocks.DIRT);
        ModItems.GRAINE_BUISSON = new ItemGraine("graine_buisson", ModBlocks.PLAN_BUISSON, Blocks.DIRT);
        ModItems.GRAINE_BUISSON_DE_FLEURS_BLANCHES = new ItemGraine("graine_buisson_de_fleurs_blanches", ModBlocks.PLAN_BUISSON_DE_FLEURS_BLANCHES, Blocks.DIRT);
        ModItems.GRAINE_BUISSON_ETRANGE = new ItemGraine("graine_buisson_etrange", ModBlocks.PLAN_BUISSON_ETRANGE, Blocks.DIRT);
        ModItems.GRAINE_BUISSON_HERBEUX = new ItemGraine("graine_buisson_herbeux", ModBlocks.PLAN_BUISSON_HERBEUX, Blocks.DIRT);
        ModItems.GRAINE_CAMOMILLE = new ItemGraine("graine_camomille", ModBlocks.PLAN_CAMOMILLE, Blocks.DIRT);
        ModItems.GRAINE_CHARDON = new ItemGraine("graine_chardon", ModBlocks.PLAN_CHARDON, Blocks.DIRT);
        ModItems.GRAINE_CIBOULETTE = new ItemGraine("graine_ciboulette", ModBlocks.PLAN_CIBOULETTE, Blocks.DIRT);
        ModItems.GRAINE_CLOCHETTES = new ItemGraine("graine_clochettes", ModBlocks.PLAN_CLOCHETTES, Blocks.DIRT);
        ModItems.GRAINE_COSMOS = new ItemGraine("graine_cosmos", ModBlocks.PLAN_COSMOS, Blocks.DIRT);
        ModItems.GRAINE_ETOILE_DES_GLACIERS = new ItemGraine("graine_etoile_des_glaciers", ModBlocks.PLAN_ETOILE_DES_GLACIERS, Blocks.DIRT);
        ModItems.GRAINE_GERANIUM = new ItemGraine("graine_geranium", ModBlocks.PLAN_GERANIUM, Blocks.DIRT);
        ModItems.GRAINE_GLYCINE = new ItemGraine("graine_glycine", ModBlocks.PLAN_GLYCINE, Blocks.DIRT);
        ModItems.GRAINE_GUI = new ItemGraine("graine_gui", ModBlocks.PLAN_GUI, Blocks.DIRT);
        ModItems.GRAINE_GUZMANIAS = new ItemGraine("graine_guzmanias", ModBlocks.PLAN_GUZMANIAS, Blocks.DIRT);
        ModItems.GRAINE_HIBISCUS = new ItemGraine("graine_hibiscus", ModBlocks.PLAN_HIBISCUS, Blocks.DIRT);
        ModItems.GRAINE_HORTENSIAS = new ItemGraine("graine_hortensias", ModBlocks.PLAN_HORTENSIAS, Blocks.DIRT);
        ModItems.GRAINE_HOUX = new ItemGraine("graine_houx", ModBlocks.PLAN_HOUX, Blocks.DIRT);
        ModItems.GRAINE_HYDRANGEE = new ItemGraine("graine_hydrangee", ModBlocks.PLAN_HYDRANGEE, Blocks.DIRT);
        ModItems.GRAINE_IRIS = new ItemGraine("graine_iris", ModBlocks.PLAN_IRIS, Blocks.DIRT);
        ModItems.GRAINE_JACINTHE_DES_BOIS = new ItemGraine("graine_jacinthe_des_bois", ModBlocks.PLAN_JACINTHE_DES_BOIS, Blocks.DIRT);
        ModItems.GRAINE_JASMIN = new ItemGraine("graine_jasmin", ModBlocks.PLAN_JASMIN, Blocks.DIRT);
        ModItems.GRAINE_JOLI_BUISSON = new ItemGraine("graine_joli_buisson", ModBlocks.PLAN_JOLI_BUISSON, Blocks.DIRT);
        ModItems.GRAINE_JONQUILLE = new ItemGraine("graine_jonquille", ModBlocks.PLAN_JONQUILLE, Blocks.DIRT);
        ModItems.GRAINE_LAURIER = new ItemGraine("graine_laurier", ModBlocks.PLAN_LAURIER, Blocks.DIRT);
        ModItems.GRAINE_LAVANDE = new ItemGraine("graine_lavande", ModBlocks.PLAN_LAVANDE, Blocks.DIRT);
        ModItems.GRAINE_LYS = new ItemGraine("graine_lys", ModBlocks.PLAN_LYS, Blocks.DIRT);
        ModItems.GRAINE_MANDRAGORE = new ItemGraine("graine_mandragore", ModBlocks.PLAN_MANDRAGORE, Blocks.DIRT);
        ModItems.GRAINE_MENTHE = new ItemGraine("graine_menthe", ModBlocks.PLAN_MENTHE, Blocks.DIRT);
        ModItems.GRAINE_MUGUET = new ItemGraine("graine_muguet", ModBlocks.PLAN_MUGUET, Blocks.DIRT);
        ModItems.GRAINE_MYOSOTIS = new ItemGraine("graine_myosotis", ModBlocks.PLAN_MYOSOTIS, Blocks.DIRT);
        ModItems.GRAINE_NARCISSES = new ItemGraine("graine_narcisses", ModBlocks.PLAN_NARCISSES, Blocks.DIRT);
        ModItems.GRAINE_OEILLETS = new ItemGraine("graine_oeillets", ModBlocks.PLAN_OEILLETS, Blocks.DIRT);
        ModItems.GRAINE_ORCHIDEE_ROSE = new ItemGraine("graine_orchidee_rose", ModBlocks.PLAN_ORCHIDEE_ROSE, Blocks.DIRT);
        ModItems.GRAINE_PENSEES = new ItemGraine("graine_pensees", ModBlocks.PLAN_PENSEES, Blocks.DIRT);
        ModItems.GRAINE_PERSIL = new ItemGraine("graine_persil", ModBlocks.PLAN_PERSIL, Blocks.DIRT);
        ModItems.GRAINE_PIVOINE = new ItemGraine("graine_pivoine", ModBlocks.PLAN_PIVOINE, Blocks.DIRT);
        ModItems.GRAINE_PLANTE_ETRANGE = new ItemGraine("graine_plante_etrange", ModBlocks.PLAN_PLANTE_ETRANGE, Blocks.DIRT);
        ModItems.GRAINE_PLANTE_GRASSE_COLOREE = new ItemGraine("graine_plante_grasse_coloree", ModBlocks.PLAN_PLANTE_GRASSE_COLOREE, Blocks.DIRT);
        ModItems.GRAINE_POIVRON_JAUNE = new ItemGraine("graine_poivron_jaune", ModBlocks.PLAN_POIVRON_JAUNE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_POIVRON_ROUGE = new ItemGraine("graine_poivron_rouge", ModBlocks.PLAN_POIVRON_ROUGE, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_POIVRON_VERT = new ItemGraine("graine_poivron_vert", ModBlocks.PLAN_POIVRON_VERT, Blocks.FARMLAND, EnumPlantType.Crop);
        ModItems.GRAINE_ROMARIN = new ItemGraine("graine_romarin", ModBlocks.PLAN_ROMARIN, Blocks.DIRT);
        ModItems.GRAINE_RONCES = new ItemGraine("graine_ronces", ModBlocks.PLAN_RONCES, Blocks.DIRT);
        ModItems.GRAINE_SALICORNE = new ItemGraine("graine_salicorne", ModBlocks.PLAN_SALICORNE, Blocks.SAND);
        ModItems.GRAINE_VERGE_D_OR = new ItemGraine("graine_verge_d_or", ModBlocks.PLAN_VERGE_D_OR, Blocks.DIRT);
        ModItems.GRAINE_VERVEINE = new ItemGraine("graine_verveine", ModBlocks.PLAN_VERVEINE, Blocks.DIRT);
        ModItems.GRAINE_VIOLETTES = new ItemGraine("graine_violettes", ModBlocks.PLAN_VIOLETTES, Blocks.DIRT);
        ModItems.GRAINE_ESTRAGON = new ItemGraine("graine_estragon", ModBlocks.PLAN_ESTRAGON, Blocks.DIRT);
        ModItems.GRAINE_PAVOT = new ItemGraine("graine_pavot", ModBlocks.PLAN_PAVOT, Blocks.DIRT);
        ModItems.GRAINE_GIROFLIER = new ItemGraine("graine_giroflier", ModBlocks.PLAN_GIROFLIER, Blocks.DIRT);
        ModItems.GRAINE_RHUBARBE = new ItemGraine("graine_rhubarbe", ModBlocks.PLAN_RHUBARBE, Blocks.DIRT, EnumPlantType.Crop);
        ModItems.GRAINE_SAUGE = new ItemGraine("graine_sauge", ModBlocks.PLAN_SAUGE, Blocks.DIRT);
        ModItems.GRAINE_SUREAU = new ItemGraine("graine_sureau", ModBlocks.PLAN_SUREAU, Blocks.DIRT);
        ModItems.GRAINE_THYM = new ItemGraine("graine_thym", ModBlocks.PLAN_THYM, Blocks.DIRT);
        ModItems.GRAINE_MANDRAGORE = new ItemGraine("graine_mandragore", ModBlocks.PLAN_MANDRAGORE, Blocks.DIRT);

        ModItems.GRAINE_CAPRE = new ItemGraine("graine_capre", ModBlocks.PLAN_CAPRE, Blocks.DIRT);
        ModItems.GRAINE_PLANTE_GRASSE = new ItemGraine("graine_plante_grasse", ModBlocks.PLAN_PLANTE_GRASSE, Blocks.DIRT);
        ModItems.GRAINE_BUIS = new ItemGraine("graine_buis", ModBlocks.PLAN_BUIS, Blocks.DIRT);
        ModItems.GRAINE_LIERRE_TERRESTRE = new ItemGraine("graine_lierre_terrestre", ModBlocks.PLAN_LIERRE_TERRESTRE, Blocks.DIRT);
        ModItems.GRAINE_COQUELICOT = new ItemGraine("graine_coquelicot", ModBlocks.PLAN_COQUELICOT, Blocks.DIRT);
        ModItems.GRAINE_BOUTON_D_OR = new ItemGraine("graine_bouton_d_or", ModBlocks.PLAN_BOUTON_D_OR, Blocks.DIRT);
        ModItems.GRAINE_TULIPE_ROUGE = new ItemGraine("graine_tulipe_rouge", ModBlocks.PLAN_TULIPE_ROUGE, Blocks.DIRT);
        ModItems.GRAINE_TULIPE_ORANGE = new ItemGraine("graine_tulipe_orange", ModBlocks.PLAN_TULIPE_ORANGE, Blocks.DIRT);
        ModItems.GRAINE_TULIPE_ROSE = new ItemGraine("graine_tulipe_rose", ModBlocks.PLAN_TULIPE_ROSE, Blocks.DIRT);
        ModItems.GRAINE_TULIPE_BLANCHE = new ItemGraine("graine_tulipe_blanche", ModBlocks.PLAN_TULIPE_BLANCHE, Blocks.DIRT);
        ModItems.GRAINE_AIL = new ItemGraine("graine_ail", ModBlocks.PLAN_AIL, Blocks.DIRT);
        ModItems.GRAINE_OIGNON = new ItemGraine("graine_oignon", ModBlocks.PLAN_OIGNON, Blocks.DIRT);
        ModItems.GRAINE_ORCHIDEE_BLEUE = new ItemGraine("graine_orchidee_bleue", ModBlocks.PLAN_ORCHIDEE_BLEUE, Blocks.DIRT);
        ModItems.GRAINE_ROSIER = new ItemGraine("graine_rosier", ModBlocks.PLAN_ROSIER, Blocks.DIRT);
        ModItems.GRAINE_LIERRE_FLEURI = new ItemGraine("graine_lierre_fleuri", ModBlocks.PLAN_LIERRE_FLEURI, Blocks.DIRT);
        ModItems.GRAINE_HAIE = new ItemGraine("graine_haie", ModBlocks.PLAN_HAIE, Blocks.DIRT);

        ModItems.GRAINE_PISSENLIT = new ItemGraine("graine_pissenlit", ModBlocks.PLAN_PISSENLIT, Blocks.DIRT);
        ModItems.GRAINE_LILAS = new ItemGraine("graine_lilas", ModBlocks.PLAN_LILAS, Blocks.DIRT);
        ModItems.GRAINE_TOURNESOL = new ItemGraine("graine_tournesol", ModBlocks.PLAN_TOURNESOL, Blocks.DIRT);
        ModItems.GRAINE_ALLIUM = new ItemGraine("graine_allium", ModBlocks.PLAN_ALLIUM, Blocks.DIRT);
        ModItems.GRAINE_HOUSTONIE_BLEUE = new ItemGraine("graine_houstonie_bleue", ModBlocks.PLAN_HOUSTONIE_BLEUE, Blocks.DIRT);
        ...
        //Insectes
        ModItems.GRAINE_ABEILLE = new ItemGraine("graine_abeille", ModBlocks.PLAN_ABEILLE, Blocks.DIRT);
        ModItems.GRAINE_ARAIGNEE = new ItemGraine("graine_araignee", ModBlocks.PLAN_ARAIGNEE, Blocks.DIRT);
        ModItems.GRAINE_ASTICOT = new ItemGraine("graine_asticot", ModBlocks.PLAN_ASTICOT, Blocks.DIRT);
        ModItems.GRAINE_CHENILLE = new ItemGraine("graine_chenille", ModBlocks.PLAN_CHENILLE, Blocks.DIRT);
        ModItems.GRAINE_COCCINELLE = new ItemGraine("graine_coccinelle", ModBlocks.PLAN_COCCINELLE, Blocks.DIRT);
        ModItems.GRAINE_COCHENILLE = new ItemGraine("graine_cochenille", ModBlocks.PLAN_COCHENILLE, Blocks.DIRT);
        ModItems.GRAINE_ESCARGOT = new ItemGraine("graine_escargot", ModBlocks.PLAN_ESCARGOT, Blocks.DIRT);
        ModItems.GRAINE_FOURMI = new ItemGraine("graine_fourmi", ModBlocks.PLAN_FOURMI, Blocks.DIRT);
        ModItems.GRAINE_GALLE = new ItemGraine("graine_galle", ModBlocks.PLAN_GALLE, Blocks.DIRT);
        ModItems.GRAINE_GUEPE = new ItemGraine("graine_guepe", ModBlocks.PLAN_GUEPE, Blocks.DIRT);
        ModItems.GRAINE_LARVE = new ItemGraine("graine_larve", ModBlocks.PLAN_LARVE, Blocks.DIRT);
        ModItems.GRAINE_MITE = new ItemGraine("graine_mite", ModBlocks.PLAN_MITE, Blocks.DIRT);
        ModItems.GRAINE_MORPION = new ItemGraine("graine_morpion", ModBlocks.PLAN_MORPION, Blocks.DIRT);
        ModItems.GRAINE_MOUCHE = new ItemGraine("graine_mouche", ModBlocks.PLAN_MOUCHE, Blocks.DIRT);
        ModItems.GRAINE_PAPILLON_COMMUN = new ItemGraine("graine_papillon_commun", ModBlocks.PLAN_PAPILLON_COMMUN, Blocks.DIRT);
        ModItems.GRAINE_PAPILLON_RARE = new ItemGraine("graine_papillon_rare", ModBlocks.PLAN_PAPILLON_RARE, Blocks.DIRT);
        ModItems.GRAINE_PUCERON = new ItemGraine("graine_puceron", ModBlocks.PLAN_PUCERON, Blocks.DIRT);
        ModItems.GRAINE_SCARABEE = new ItemGraine("graine_scarabee", ModBlocks.PLAN_SCARABEE, Blocks.DIRT);
        ModItems.GRAINE_SCORPION = new ItemGraine("graine_scorpion", ModBlocks.PLAN_SCORPION, Blocks.DIRT);
        ModItems.GRAINE_TIQUE = new ItemGraine("graine_tique", ModBlocks.PLAN_TIQUE, Blocks.DIRT);
        ModItems.GRAINE_VER_DE_FARINE = new ItemGraine("graine_ver_de_farine", ModBlocks.PLAN_VER_DE_FARINE, Blocks.DIRT);
        ModItems.GRAINE_VER_DE_TERRE = new ItemGraine("graine_ver_de_terre", ModBlocks.PLAN_VER_DE_TERRE, Blocks.DIRT);
        ModItems.GRAINE_VER_A_SOIE = new ItemGraine("graine_buisson_ver_a_soie", ModBlocks.PLAN_VER_A_SOIE, Blocks.DIRT);
    }
    ...
    public static void register() {
        ...
        //Insectes
        registerItem(ModItems.GRAINE_ABEILLE);
        registerItem(ModItems.GRAINE_ARAIGNEE);
        registerItem(ModItems.GRAINE_ASTICOT);
        registerItem(ModItems.GRAINE_CHENILLE);
        registerItem(ModItems.GRAINE_COCCINELLE);
        registerItem(ModItems.GRAINE_COCHENILLE);
        registerItem(ModItems.GRAINE_ESCARGOT);
        registerItem(ModItems.GRAINE_FOURMI);
        registerItem(ModItems.GRAINE_GALLE);
        registerItem(ModItems.GRAINE_GUEPE);
        registerItem(ModItems.GRAINE_LARVE);
        registerItem(ModItems.GRAINE_MITE);
        registerItem(ModItems.GRAINE_MORPION);
        registerItem(ModItems.GRAINE_MOUCHE);
        registerItem(ModItems.GRAINE_PAPILLON_COMMUN);
        registerItem(ModItems.GRAINE_PAPILLON_RARE);
        registerItem(ModItems.GRAINE_PUCERON);
        registerItem(ModItems.GRAINE_SCARABEE);
        registerItem(ModItems.GRAINE_SCORPION);
        registerItem(ModItems.GRAINE_TIQUE);
        registerItem(ModItems.GRAINE_VER_DE_FARINE);
        registerItem(ModItems.GRAINE_VER_DE_TERRE);
        registerItem(ModItems.GRAINE_VER_A_SOIE);
    }
