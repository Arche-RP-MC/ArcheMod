...
public class ModBlocks {
    ...
    public static final Block PLAN_BUISSON_HERBEUX = new BlocPlantesBotaniste("plan_buisson_herbeux", ModItems.GRAINE_BUISSON_HERBEUX, ModItems.PLANTE_BUISSON_HERBEUX, 2, 2, 2);
    public static final Block PLAN_CAMOMILLE = new BlocPlantesBotaniste("plan_camomille", ModItems.GRAINE_CAMOMILLE, ModItems.PLANTE_CAMOMILLE, 2, 2, 2);
