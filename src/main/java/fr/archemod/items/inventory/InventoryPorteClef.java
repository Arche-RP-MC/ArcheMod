...
public class InventoryPorteClef implements IInventory {
    private final NonNullList<ItemStack> content;
    public int size;

    public InventoryPorteClef(ItemStack container, int size) {
        this.size = size;
     ...
     */
    @Override
    public boolean isItemValidForSlot(int index, ItemStack stack) { return stack.getItem() instanceof Clef; }
