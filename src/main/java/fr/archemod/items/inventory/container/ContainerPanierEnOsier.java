...
import fr.archemod.items.inventory.slot.SlotPanierEnOsier;
...
public class ContainerPanierEnOsier extends Container {
    public InventoryPanierEnOsier inventoryPanierEnOsier;
    public int rows;

    public ContainerPanierEnOsier(InventoryPlayer playerInv, InventoryPanierEnOsier inv) {
        this.inventoryPanierEnOsier = inv;
        ...
        for (j = 0; j < this.rows; ++j) {
            for (k = 0; k < 6; ++k) {
                this.addSlotToContainer(new SlotPanierEnOsier(inv, k + j * 6, 26 + k * 18, 18 + j * 18));
            }
        }
    ...
    public void writeToNBT(ItemStack stack) {
        ...
        inventoryPanierEnOsier.writeToNBT(stack.getTagCompound());
    }
